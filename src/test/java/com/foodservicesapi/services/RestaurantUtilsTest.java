...
class RestaurantUtilsTest {
    ...
    void convertWhitespaceToSingleSpace(String input, String expected){
    ...
    void removeHashtagIdentifiers(String input, String expected){
    ...
    void removeApostrophes(String input, String expected){
    ...
    void removeTextInParenthesisTest(String input, String expected){
